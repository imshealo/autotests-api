...
def assert_create_course_response(request: CreateCourseRequestSchema, response: CreateCourseResponseSchema):
    ...
    Args:
        request: Исходный запрос на создание курса.
        response: Ответ API с данными курса.
...
def assert_get_courses_response(
    ...
    Args:
        get_courses_response: Ответ API при запросе списка курсов.
        create_course_responses: Список API ответов при создании курсов.
...
def assert_update_course_response(
    ...
    Args:
        request: Исходный запрос на обновление курса.
        response: Ответ API с обновленными данными курса.
