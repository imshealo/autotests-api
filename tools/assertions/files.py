...
def assert_create_file_response(request: CreateFileRequestSchema, response: CreateFileResponseSchema):
    ...
    Args:
        request: Исходный запрос на создание файла.
        response: Ответ API с данными файла.
...
def assert_file_is_accessible(url: str):
    ...
    Raises:
        AssertionError: Если файл не доступен.
    """
...
def assert_file(actual: FileSchema, expected: FileSchema):
    ...
    Args:
        actual: Фактические данные файла
...
def assert_get_file_response(
    ...
    Args:
        get_file_response: Ответ API при запросе данных файла.
        create_file_response: Ответ API при создании файла.

    Raises:
        AssertionError: Если данные файла не совпадают.
    """
...
def assert_create_file_with_empty_filename_response(actual: ValidationErrorResponseSchema):
    ...
    Args:
        actual: Ответ от API с ошибкой валидации, который необходимо проверить.
...
def assert_file_not_found_response(actual: InternalErrorResponseSchema):
    ...
    Raises:
        AssertionError: Если фактический ответ не соответствует ошибке "File not found"
    """
...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Функция для проверки ошибки, если передан некорректный идентификатор файла.
    ...
    expected = ValidationErrorResponseSchema(
        details=[
            ValidationErrorSchema(
                ...
                context={"error": uuid_invalid_char_error},
                message=f"Input should be a valid UUID, {uuid_invalid_char_error}",
