...
from tools.paths import testdata_files_path
...
class TestFiles:
    ...
    def image_path() -> str:
        """
        Возвращает абсолютный путь к тестовому изображению `image.png`.

        Returns:
            Абсолютный путь к файлу `clients/testdata/files/image.png`.
        """
        return str(testdata_files_path() / "image.png")
    ...
    def test_create_file(self, files_client: FilesClient):
        request = CreateFileRequestSchema(upload_file=self.image_path())
